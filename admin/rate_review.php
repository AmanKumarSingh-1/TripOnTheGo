    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                <h3 class="mb-4 text-light">RATINGS & REVIEWS</h3>

                <div class="card border-0 shadow mb-4">
                    <div class="card-body">

                        <div class="text-end mb-4">
                            <a href="?seen=all" class="btn btn-dark rounder-pill shadow-none btn-sm"><i class="bi bi-check-all"></i> Mark all Read</a>
                            <a href="?del=all" class="btn btn-danger rounder-pill shadow-none btn-sm"><i class="bi bi-trash"></i> Delete all </a>
                        </div>
