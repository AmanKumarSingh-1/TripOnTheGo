...
<body class="bg-light">
        ...
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        <div class="d-flex algn-item-centre justify-content-between mb-3">
                                    ...
                                    <div class="container-fluid p-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label fw-bold">Phone Numbers (With Countries Code)</label>
                ...
                <div class="card border-0 shadow mb-4">
                    <div class="card-body">
                        <div class="d-flex algn-items-centre justify-content-between mb-3">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="member_picture" id="member_picture_inp" acccept=".jpg, .png, .webp, .jpeg" class="form-control shadow-none" required>
                                    </div>
                                </div>
                                <div class="modal-footer">
    ...
    <script>
        ...
        function get_contacts() {
            let contacts_p_id = ['address', 'gmap', 'pn1', 'pn2', 'email', 'tw', 'fb'];
        ...
        function contacts_inp(data){
            let contacts_inp_id = ['address_inp', 'gmap_inp', 'pn1_inp', 'pn2_inp', 'email_inp', 'tw_inp', 'fb_inp','iframe_inp'];
        ...
        function upd_contacts(){
            let index = ['address', 'gmap', 'pn1', 'pn2', 'email', 'tw', 'fb','iframe'];
            let contacts_inp_id = ['address_inp', 'gmap_inp', 'pn1_inp', 'pn2_inp', 'email_inp', 'tw_inp', 'fb_inp', 'iframe_inp'];
