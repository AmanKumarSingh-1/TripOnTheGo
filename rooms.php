...
<body class="bg-light">
            ...
            <div class="col-lg-3 col-md-12 mb-lg-0 mb-4 ps-4">
                <nav class="navbar navbar-expand-lg navbar-light bg-white rounded">
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        ...
                        <button class="navbar-toggler shadow-none" type="button" data-bs-toggle="collapse" data-bs-target="#fliterDropdown" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="navbar-toggler-icon"></span>
                        </button>
                        <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="fliterDropdown">
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <input type="date" id="checkin" value="<?php echo $checkin_default ?>" onchange="chk_avail_filter()" class="form-control shadow-none mb-3">
                                <label for="" class="form-label">Check-out</label>
                                <input type="date" id="checkout" value="<?php echo $checkout_default ?>" onchange="chk_avail_filter()" class="form-control shadow-none">
                            </div>
    ...
    <script>
        ...
        function facilities_clear() {
            let get_facilities = document.querySelectorAll('[name="facilities"]');
            get_facilities.forEach((facility) => {
