...
<body class="bg-light">
                        ...
                        <form action="pay_now.php" method="POST" id="booking_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input name="check_in" onchange="check_availability()" type="date" class="form-control shadow-none" required>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label class="form-label">Check-out</label>
                                    <input name="check_out" onchange="check_availability()" type="date" class="form-control shadow-none" required>
                                </div>
                                <div class="col-12">
    ...
    <script>
        ...
        let pay_now = document.querySelector('button[name="pay_now"]');
        let info_loader = document.getElementById('info_loader');

        function check_availability() {
            let checkin_val = booking_form.elements['check_in'].value;
            let checkout_val = booking_form.elements['check_out'].value;
            ...
            if(checkin_val != '' && checkout_val != '') {
                ...
                xhr.onload = function() {
                    ...
                    if(data.status == 'check_in_out_equal') {
                        ...
                        pay_info.innerText = "Check-out date cannot be earlier than Check-in date!";
                    }
